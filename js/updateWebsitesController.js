    ...
    $scope.similarRegex = function(url, test_path)
        {
            ...
            if (mymatch === null)
            {
                ...
                if (print)
                {
                    ...
                    return {
                        bool: false,
                        message: "error in url returned by query <br>" + "main url: " + url + "<br>" + "Example url: " + test_path + "<br>" +
            ...
            else if (key === null)
            {
                return {
                    bool: false,
                    message: "error in url typed <br>" + "main url: " + url + "<br>" + "Example url: " + test_path + "<br>",
                    url: "",
                    path: ""
                };
            }
